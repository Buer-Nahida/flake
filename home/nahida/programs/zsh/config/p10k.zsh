...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ROOT_VISUAL_IDENTIFIER_EXPANSION='󰙅'
  ...
  typeset -g POWERLEVEL9K_DIR_{CODE,CONFIG,GITHUB,HOME,DEFAULT}_NON_EXISTENT_VISUAL_IDENTIFIER_EXPANSION=''
  #
